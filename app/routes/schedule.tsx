...
import { GoogleCalendar as GoogleCalendarLink, ICalendar } from 'datebook';
...
export const meta: MetaFunction = () => ({
	title: 'Schedule — Marty Penner and Meaghan Jones',
});
			...
			smallDeviceBlocks={[
				<div key="ceremony" className="mx-4">
					...
					<a
						...
						className="mb-4 flex w-full items-center justify-center border border-black bg-gray-100 px-4 py-3 text-lg font-semibold uppercase hover:bg-gray-800 hover:text-white"
					>
						Map
					</a>
					...
					<button
						type="button"
						className="mb-4 flex w-full items-center justify-center border border-black bg-gray-100 py-4 px-10 text-lg font-semibold uppercase hover:bg-gray-800 hover:text-white"
						onClick={() => {
					...
					<a
						...
						className="mb-4 flex w-full items-center justify-center border border-black bg-gray-100 py-4 px-10 text-center text-lg font-semibold uppercase hover:bg-gray-800 hover:text-white"
						target="_blank"
						rel="noopener noreferrer"
					>
						<GoogleCalendar className="mr-2 h-12 w-12" aria-hidden="true" />
						Add to Google calendar
					</a>
				</div>,

				<div key="reception" className="mx-4">
					<h3 className="text-gray mx-auto p-8 text-center text-4xl uppercase">
						Reception
					</h3>
