    ...
    <InfoLayout
      ...
      smallDeviceBlocks={[
        <React.Fragment key="shuttle">
          ...
          <h3 className="text-4xl text-gray text-center uppercase mx-auto pt-4 pb-8">
            Shuttle from entrance lot to ceremony location
          </h3>

          <p className="font-cardo italic text-center mb-6">
            Saturday, October 15, 2022
          </p>

          <p className="font-cardo text-center mb-12">
      ...
      largeDeviceBlocks={[
        {
          left: (
            <React.Fragment>
              <div className="flex items-center justify-center pt-8 mb-8">
                <Image
                  src={shuttleVan}
                  width={72}
                  height={72}
              ...
              <h3 className="text-4xl md:text-5xl text-gray text-center uppercase mx-auto pb-8 px-8">
                Shuttle from entrance lot to ceremony location
              </h3>
              ...
              <p className="font-cardo text-gray text-center mx-auto pb-8 px-8">
